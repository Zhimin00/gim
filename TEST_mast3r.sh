#! /bin/bash
gpus=$1
python test.py --gpus $gpus --weight mast3r_finetune --version 100h --test --batch_size 1 --tests         ETH3DI2 --img_size 512 --fine_size 1600
python test.py --gpus $gpus --weight mast3r_finetune --version 100h --test --batch_size 1 --tests         ETH3DO2 --img_size 512 --fine_size 1600
